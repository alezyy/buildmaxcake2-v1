...
<?php echo $this->Form->create('ApplicationsLease'); ?>
	<fieldset>
		<legend><?php echo __('Edit Applications Lease'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ApplicationsLease.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('ApplicationsLease.id'))); ?></li>
