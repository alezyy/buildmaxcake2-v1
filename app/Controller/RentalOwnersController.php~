	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->RentalOwner->save($this->request->data)) {
				$this->Session->setFlash(__('The rental owner has been saved.'));
				return $this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The rental owner could not be saved. Please, try again.'));
			}
		}
	}
 ...
 */
	public function delete($id = null) {
		...
		if ($this->RentalOwner->delete()) {
			$this->Session->setFlash(__('The rental owner has been deleted.'));
		} else {
			$this->Session->setFlash(__('The rental owner could not be deleted. Please, try again.'));
		}
		return $this->redirect(array('action' => 'index'));
	}
}
